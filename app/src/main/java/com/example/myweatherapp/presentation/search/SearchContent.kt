...
fun SearchContent(
    ...
    SearchBar(
        ...
        placeholder = { Text(text = stringResource(id = R.string.search_city)) },
        ...
        when (val searchState = state.searchState) {
            ...
            SearchStore.State.SearchState.ErrorSearch -> {
            ...
            SearchStore.State.SearchState.LoadingSearch -> {
            ...
            is SearchStore.State.SearchState.Success -> {
                LazyColumn(
                    ...
                    items(searchState.listCity, key = {
                        it.id
                    }) { city ->
                        CityCard(city = city){
